...
// Flow-space centre of a port on whichever side it's actually registered on —
// our node shapes use all four sides (box-ports: left/right; box/dot: top/bottom,
// dot: all four), unlike a left/right-only port model, so this reads `port.side`
